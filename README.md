...
In this project, a multi-class dataset is divided into 70-30 for training and testing with 10 different samples. SVM is optimized for every sample with 1000 iterations and best parameters are noted down.

# DATASET

Data has been normalized by using the Z-normalization method and divided into two data sets: a training set containing 10429 samples, and a test set containing the 10437 samples.
